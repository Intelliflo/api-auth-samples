    ...
    public class IFOAuthHandler : AuthenticationHandler<IFOAuthOptions>
    {
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                values = query.GetValues("session_state");
                ...
                var oauth2Token = await GetOAuthToken(code);
        ...
        protected override Task ApplyResponseChallengeAsync()
        {
            ...
            if (challenge != null)
            {
                ...
                var redirectContext = new IFOAuthRedirectContext(
                    Context, Options,
        ...
        public async Task<bool> InvokeReturnPathAsync()
        {
            ...
            if (context.SignInAsAuthenticationType != null && context.Identity != null)
            {
                ...
                Context.Authentication.SignIn(context.Properties ?? new AuthenticationProperties{IsPersistent = true}, signInIdentity); // bug here
            }
        ...
        private async Task<JObject> GetOAuthToken(string code)
        {
        ...
        {
            var graphRequest = new HttpRequestMessage(HttpMethod.Post, Options.UserInfoEndpoint);
